    ...
    <main className="page">
      <div className="container">
        ...
        <div className="dashboard-grid grid grid-2">
          <div className="dashboard-card card"><h3>{t('total_questions')}</h3><p className="stat-value">0</p></div>
          <div className="dashboard-card card"><h3>{t('accuracy')}</h3><p className="stat-value">0%</p></div>
        </div>
