...
const generateAIResponse = (message, language = 'en') => {
  const responses = {
    ...
    hi: {
      ...
      'mcq': 'मैं आपके लिए अभ्यास MCQ जेनरेट कर सकता हूं। आपको कौन सी परीक्षा और विषय में रुची है?',
      'current affairs': 'आपकी परीक्षा के लिए प्रासंगिक नवीनतम समसामयिक जानकारी लाता हूं।',
      'default': 'मैं आपकी परीक्षा की तैयारी में मदद के लिए यहां हूं। मुझसे परीक्षाओं, MCQs, या करंट अफेयर्स के बारे में पूछें!'
    }
  };
